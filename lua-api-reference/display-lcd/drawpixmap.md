...
{% hint style="info" %}
If you draw the same image repeatedly, prefer loading it once with [`Bitmap.open`](../bitmap/open.md) and then drawing it with [`lcd.drawBitmap`](drawbitmap.md).
{% endhint %}
...
* [ ] [Color LCD radios](../../overview/radios/#radios-with-color-lcd-screen)
...
* [`lcd.drawBitmap`](drawbitmap.md)
* [`Bitmap.open`](../bitmap/open.md)
* [Screen Constants](../constants/screen-constants.md)
