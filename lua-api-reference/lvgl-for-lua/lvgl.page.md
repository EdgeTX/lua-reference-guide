...
Setting 'navButtons' to true will add two additional buttons to the header for touch screen navigation. These will call the 'prev' and 'next' functions respectively when tapped.
