...
[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-close.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.close`
- Doc id: `lvgl.close`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:252`
...
<div class="decision-panel" data-item-id="lvgl.close">
...
<tbody>
<tr><td><code>obj</code></td><td>param</td><td><code>object</code></td><td>LVGL object previously created by the `lvgl` library</td><td><select data-field-kind="param" data-field-name="obj" data-current-type="object"><option value="TODO">TODO</option><option value="integer">integer</option><option value="number">number</option><option value="string">string</option><option value="boolean">boolean</option><option value="table">table</option><option value="function">function</option><option value="pointer">pointer</option><option value="nil">nil</option><option value="integer|string">integer|string</option><option value="table|nil">table|nil</option><option value="function|nil">function|nil</option><option value="string|nil">string|nil</option></select><input type="text" placeholder="Custom type" data-field-kind="param" data-field-name="obj" data-custom-type="true" /></td></tr>
...
<script type="application/json" class="decision-payload">{&quot;item_id&quot;: &quot;lvgl.close&quot;, &quot;symbol&quot;: &quot;lvgl.close&quot;, &quot;summary&quot;: &quot;Close an LVGL object that represents a closable container or dialog.&quot;, &quot;parameters&quot;: [{&quot;name&quot;: &quot;obj&quot;, &quot;type&quot;: &quot;object&quot;, &quot;required&quot;: true, &quot;description&quot;: &quot;LVGL object previously created by the `lvgl` library&quot;}], &quot;returns&quot;: [{&quot;name&quot;: &quot;none&quot;, &quot;type&quot;: &quot;unknown&quot;, &quot;description&quot;: &quot;&quot;}], &quot;notes&quot;: [], &quot;since&quot;: &quot;2.11.0&quot;}</script>
</div>
