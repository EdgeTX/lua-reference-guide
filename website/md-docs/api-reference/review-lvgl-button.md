...
[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-button.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.button`
- Doc id: `lvgl.button`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:834`
...
<div class="decision-panel" data-item-id="lvgl.button">
