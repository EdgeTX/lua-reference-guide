...
[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-timer.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.timer`
- Doc id: `lvgl.timer`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:1090`
...
<div class="decision-panel" data-item-id="lvgl.timer">
