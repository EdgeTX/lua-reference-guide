...
[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-source.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.source`
- Doc id: `lvgl.source`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:1135`
...
<div class="decision-panel" data-item-id="lvgl.source">
