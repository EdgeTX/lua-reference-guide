...
[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-image.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.image`
- Doc id: `lvgl.image`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:795`
...
<div class="decision-panel" data-item-id="lvgl.image">
...
<script type="application/json" class="decision-payload">{&quot;item_id&quot;: &quot;lvgl.image&quot;, &quot;symbol&quot;: &quot;lvgl.image&quot;, &quot;summary&quot;: &quot;Display an image, centered in the frame `(x, y, w, h)`. Images can be scaled to fit entirely within the frame or to fill it completely.&quot;, &quot;parameters&quot;: [{&quot;name&quot;: &quot;parent&quot;, &quot;type&quot;: &quot;object&quot;, &quot;required&quot;: false, &quot;description&quot;: &quot;optional LVGL object to attach the new object to; if omitted the object is created in the top-level script window&quot;}, {&quot;name&quot;: &quot;params&quot;, &quot;type&quot;: &quot;table&quot;, &quot;required&quot;: true, &quot;description&quot;: &quot;* `x` (number) position relative to the top-left of the parent\n   * `y` (number) position relative to the top-left of the parent\n   * `w` (number) width\n   * `h` (number) height\n   * `color` (color or function) primary color for the object\n   * `pos` (function) dynamic position callback returning `x, y`\n   * `size` (function) dynamic size callback returning `w, h`\n   * `visible` (function) dynamic visibility callback\n   * `floating` (boolean) keep the object fixed inside a scrollable container, added in 2.11.6, defaults to false\n   * `file` (string) full path to the image file on the SD card, defaults to an empty string\n   * `fill` (boolean) if true the image is scaled to completely fill the frame (may be cropped); if false it is scaled to fit entirely within the frame (may have empty borders), defaults to false&quot;}], &quot;returns&quot;: [{&quot;name&quot;: &quot;&quot;, &quot;type&quot;: &quot;table&quot;, &quot;description&quot;: &quot;LVGL object&quot;}], &quot;notes&quot;: [&quot;`w` and `h` are required.&quot;], &quot;since&quot;: &quot;2.11.0&quot;}</script>
</div>
