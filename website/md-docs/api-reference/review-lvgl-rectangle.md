...
# Review: lvgl.rectangle

[Back to dashboard](review.md) | [Open API page](display-lvgl/lvgl-rectangle.md)

## Snapshot

- Module: `lvgl`
- Current symbol: `lvgl.rectangle`
- Doc id: `lvgl.rectangle`
- Source: `radio/src/lua/api_colorlcd_lvgl.cpp:639`
...
<div class="decision-panel" data-item-id="lvgl.rectangle">
...
<script type="application/json" class="decision-payload">{&quot;item_id&quot;: &quot;lvgl.rectangle&quot;, &quot;symbol&quot;: &quot;lvgl.rectangle&quot;, &quot;summary&quot;: &quot;Display a rectangle. Based on `lvgl.box`, so all `lvgl.box` settings also apply.&quot;, &quot;parameters&quot;: [{&quot;name&quot;: &quot;parent&quot;, &quot;type&quot;: &quot;object&quot;, &quot;required&quot;: false, &quot;description&quot;: &quot;optional LVGL object to attach the new object to; if omitted the object is created in the top-level script window&quot;}, {&quot;name&quot;: &quot;params&quot;, &quot;type&quot;: &quot;table&quot;, &quot;required&quot;: true, &quot;description&quot;: &quot;* `x` (number) position relative to the top-left of the parent\n   * `y` (number) position relative to the top-left of the parent\n   * `w` (number) width\n   * `h` (number) height\n   * `color` (color or function) primary color for the object\n   * `pos` (function) dynamic position callback returning `x, y`\n   * `size` (function) dynamic size callback returning `w, h`\n   * `visible` (function) dynamic visibility callback\n   * `floating` (boolean) keep the object fixed inside a scrollable container, added in 2.11.6, defaults to false\n   * `thickness` (number) width of the border line, defaults to 1\n   * `filled` (boolean or function) if true the rectangle is filled with `color`, defaults to false (function support added in 2.11.4)\n   * `rounded` (number) if greater than 0, rounds the corners with this radius; must be &gt;= `thickness` if set, defaults to 0\n   * `opacity` (number or function) opacity from 0 (transparent) to 255 (opaque), defaults to 255&quot;}], &quot;returns&quot;: [{&quot;name&quot;: &quot;&quot;, &quot;type&quot;: &quot;table&quot;, &quot;description&quot;: &quot;LVGL object&quot;}], &quot;notes&quot;: [&quot;When used in a stand alone tool script, the rectangle automatically adds scroll bars if any child objects are placed outside its boundaries. For widgets, child objects outside the bounds are clipped instead.&quot;], &quot;since&quot;: &quot;2.11.0&quot;}</script>
</div>
